...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // 1 
    [1] = LAYOUT_split_4x6_5(KC_1, KC_1, KC_2, KC_3, KC_4, KC_5,                  KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO,
                            //-------------------------------------------------//-----------------------------------------------------------//
                            KC_NO, KC_Q, KC_W, KC_F, KC_P, KC_B,                  KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_NO,
                            //-------------------------------------------------//-----------------------------------------------------------//
                            KC_NO, HOME_A, HOME_R, HOME_S, HOME_T, KC_G,          KC_M, HOME_N, HOME_E, HOME_I, HOME_O, KC_NO,
    ...
    // 2 
    [2] = LAYOUT_split_4x6_5(KC_2, KC_1, KC_2, KC_3, KC_4, KC_5,                  KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO,
                            //-------------------------------------------------//-----------------------------------------------------------//
                            KC_NO, KC_Q, KC_W, KC_F, KC_P, KC_B,                  KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_NO,
                            //-------------------------------------------------//-----------------------------------------------------------//
                            KC_NO, HOME_A, HOME_R, HOME_S, HOME_T, KC_G,          KC_M, HOME_N, HOME_E, HOME_I, HOME_O, KC_NO,
